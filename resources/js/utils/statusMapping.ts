...
> = {
    ...
    71: { label: 'Menunggu Sub Layanan', color: 'blue', colorIcon: "yellow", icon: HelpCircle },
    72: { label: 'Selesai Sub Layanan', color: 'green', colorIcon: "green", icon: CheckCircle },
    73: { label: 'Ditolak Sub Layanan', color: 'red', colorIcon: "red", icon: XCircle },
};
